...
import ru.skillbranch.gameofthrones.ui.list.getMapHouseToFragmentPage
...
class HousesPageAdapter(activity: AppCompatActivity) : FragmentStateAdapter(activity) {
    ...
    private val tabFragmentCreators: Map<Int, () -> Fragment> = getMapHouseToFragmentPage(activity)
